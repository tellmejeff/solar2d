...
module.init = function(group)
    ...
    module.creationIncreaseInterval = gameConfig.creationIncreaseInterval
...
module.updateSteps = function()
    ...
    if (module.steps % module.creationIncreaseInterval == 0) then
        module.maxAsteroids = module.maxAsteroids + module.creationAcceleration
    end
    ...
    if (module.steps >= (module.creationIncreaseInterval * module.accelerationIncreaseInterval)) then
        steps = 0
    end
